...
urlpatterns = [
    ...
    path('profile/<int:user_id>/', views.view_public_profile, name='view_public_profile'),
    path('transactions/', views.transactions, name='transactions'),
    path('reviews/', views.reviews, name='reviews'),
    path('reviews/submit/', views.submit_review, name='submit_review'),
    
    # Goods Exchange Transaction URLs
    path('goods/request/<int:item_id>/', views.request_exchange, name='request_exchange'),
    path('goods/manage/<int:transaction_id>/', views.manage_exchange, name='manage_exchange'),
    path('goods/complete/<int:transaction_id>/', views.complete_exchange, name='complete_exchange'),
    ...
    path('initiate-password-change/', views.initiate_password_change, name='initiate_password_change'),
    ...
    # eSewa Payment URLs
    path('esewa/initiate/<int:transaction_id>/', views.esewa_initiate, name='esewa_initiate'),
    path('esewa/repay/<int:transaction_id>/', views.esewa_repayment_initiate, name='esewa_repayment_initiate'),
