...
from .models import UserProfile, MoneyTransaction, GoodsExchange
...
class KYCForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'gender', 'address', 
            'aadhaar_number', 'income_source', 'monthly_income',
            'citizenship_front', 'citizenship_back', 'selfie', 'income_proof'
        ]
        widgets = {
...
class LoanRequestForm(forms.ModelForm):
    ...
    def clean_amount(self):
        ...
        if self.borrower and amount:
            ...
            if amount > limit:
                raise forms.ValidationError(f"Amount exceeds your borrowing limit of {limit}")
        return amount
